...
async function createProgramMetadataExcelFiles(optionSets) {
  try {
    ...
    worksheet.cell(1, 1).string('id').style(headerStyles);
    worksheet.cell(1, 2).string('name').style(headerStyles);
    worksheet.cell(1, 3).string('code').style(headerStyles);
    worksheet.cell(1, 4).string('valueType').style(headerStyles);
    worksheet.cell(1, 5).string('option id').style(headerStyles);
    worksheet.cell(1, 6).string('option name').style(headerStyles);
    worksheet.cell(1, 7).string('option code').style(headerStyles);
    let rowIndex = 2;
